...
const GAME_VERSION = "4.0 OPEN BETA";
const GAME_UPDATE_DATE = "24 июля 2026";
const GAME_UPDATE_TITLE = "Исправления скинов Зефи";
...
const GAME_UPDATE_NOTES = Object.freeze([
  "Во время бега снова используется двухкадровая анимация активного скина.",
  "У игровых изображений убран клетчатый фон.",
  "Картинки магазина и круглые аватарки загружаются заранее.",
  "Перед покупкой скина появляется окно подтверждения, а после покупки — окно успешного получения.",
  "Аватарки перед стартом и после финиша всегда круглые и используют стандартную Зефи при ошибке загрузки.",
  "Физика, коллайдер, высота прыжка и игровой прогресс не изменены."
]);

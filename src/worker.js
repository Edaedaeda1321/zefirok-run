...
const GAME_UPDATE_TITLE = "Плавный бег и окно финиша";
...
const GAME_UPDATE_NOTES = Object.freeze([
  "Проблемный кадр ноги исключён из анимации всех семи скинов.",
  "Темп бега замедлен, а покачивание корпуса сделано мягче.",
  "Игровые изображения уменьшены и нормализованы для более плавной работы без микрофризов.",
  "Окно завершения забега стало компактным и полностью помещается внутри игровой области.",

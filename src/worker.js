...
const GAME_VERSION = "4.0.5 OPEN BETA";
const GAME_UPDATE_DATE = "24 июля 2026";
const GAME_UPDATE_TITLE = "Понятные бонусы и стабильный бег";
...
const GAME_UPDATE_NOTES = Object.freeze([
  "Проценты и множители бонусов скинов заменены фиксированными наградами.",
  "В магазине теперь сразу указано, сколько очков, зефира или кофе добавляет образ.",
  "Бонусы начисляются только к награде после забега и не увеличивают счёт, рекорд или рейтинг.",
  "Бег возвращён к варианту версии 4.0.3, мягкое покачивание корпуса сохранено.",
  "Исправлено обрезание аватарки в окне завершения забега.",

...
const GAME_VERSION = "0.3.10 Beta";
...
const GAME_UPDATE_NOTES = Object.freeze([
  "Название сезона аккуратнее размещено внутри бордовой рамки.",
  "Плашка премиального сезона стала крупнее и заметнее.",
  "Количество награды уменьшено и перенесено под декоративную линию.",
  "Верхняя подпись сезонного рейтинга получила новое оформление.",
...
const DEFAULT_BOT_NEWS_IMAGE_URL = `${DEFAULT_GAME_URL}assets/rating/season-news.png?v=0.3.10`;

...
const GAME_UPDATE_TITLE = "Живой бег и баланс скинов";
...
const GAME_UPDATE_NOTES = Object.freeze([
  "Для каждого скина добавлен четырёхкадровый цикл бега с заметным движением лап.",
  "Корпус Зефи мягко покачивается и пружинит в ритме шага.",
  "Окно окончания забега опущено ниже и полностью помещается внутри игровой области.",
  "Бариста теперь даёт ×1,3 к кофе, Клубничка — ×1,3 к зефиру.",
  "Пчёлка сохраняет ×1,5 к зефиру, Морячок теперь даёт ×1,5 к очкам.",

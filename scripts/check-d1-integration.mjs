...
try{
  ...
  console.log('D1 integration OK: migrations + support/revision + purchase/case retries + reward idempotency/archive + season double-claim + stale revision + price change.');
} catch(error){
